      ...
      >
        ...
        >
          ...
          <div class="sidebar-brand-text mx-3">
            <img src="{{ asset('img/gps_logo_white.png') }}" class="img img-fluid" alt="" />
          </div>
        </a>
        ...
        <!-- Nav Item - Crimes -->
        <li class="nav-item {{ request()->is('admin/manage-crimes') ? 'active' : '' }}">
          <a class="nav-link" href="/admin/manage-crimes">
            <i class="fas fa-fw fa-receipt"></i>
            <span>Manage Crimes</span></a
          >
        </li>

        <!-- Nav Item - Crimes -->
        <li class="nav-item {{ request()->is('admin/manage-emergencies') ? 'active' : '' }}">
          <a class="nav-link" href="/admin/manage-emergencies">
            <i class="fas fa-fw fa-calendar-minus"></i>
            <span>Manage Emergencies</span></a
          >
        </li>

        <!-- Nav Item - Crimes -->
        <li class="nav-item {{ request()->is('admin/manage-news') ? 'active' : '' }}">
          <a class="nav-link" href="/admin/manage-news">
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span
                >Copyright &copy; Crime & Emergency <span class="year"></span
              ></span>
            </div>
          </div>
        </footer>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <form action="/logout" method="POST" class="form">
              @csrf
              <button type="submit" class="btn btn-danger"><i class="fas fa-arrow-right"></i> Logout</button>
          </form>
          </div>
        </div>
      </div>
