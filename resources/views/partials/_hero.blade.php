      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/crimes" method="POST" class="form">
                ...
                <p class="text-muted mt-3">You are adviced to report crimes that needs only the attension of the police such as "Sexual Harassment", "Robbery" or any related emergencies.</p>
